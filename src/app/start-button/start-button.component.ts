...
export class StartButtonComponent {
  ...
  constructor(private startButtonService: StartButtonService,
  ...
  async getAndSelectRandomPlayer() {
    ...
    this.selectedPlayer = await this.startButtonService.SelectRandomPlayer(this.selectedGameMode, this.players);
    this.gameService.setSelectedPlayer(this.selectedPlayer);

    this.showButton = false;
    this.gameService.setShowButton(this.showButton);
  }
